...
% -------------------------------------------------------------------------------
% Nombre completo
\def \nombreestudiante {Josué Isaac Morales González}
% Carné
\def \uvgcarne {[CARNÉ]}
% Facultad
...
% -------------------------------------------------------------------------------
% Título completo
\def \titulotesis {Diseñar e implementar una experiencia y una interfaz de usuario intuitiva y funcional para una aplicación de recorrido con realidad aumentada en el Parque Arqueológico Kaminaljuyú, con la finalidad de fomentar la interacción, el interés histórico y cultural así como la accesibilidad del patrimonio arqueológico}
% Año de entrega
\def \anoentrega {2025}
% Asesor
\def \nombreasesor {M. Ed. Dennis Moritz Aldana Moscoso}
% Número de colegiado del asesor
\def \colegiadoasesor {11197}

% Datos del tribunal examinador:
% -------------------------------------------------------------------------------
% Nombre del primer examinador
\def \nombreprimerex {Mgtr. Inga. Dulce Chacón}
% Nombre del segundo examinador
\def \nombresegundoex {[NOMBRE DEL SEGUNDO EXAMINADOR]}
% Año de aprobación
